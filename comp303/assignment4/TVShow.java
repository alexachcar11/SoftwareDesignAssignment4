...
public class TVShow implements Watchable, Bingeable<Episode>, Cloneable {
    ...
    private PublishingStudio aStudio;
     ...
     */
    public TVShow(String pTitle, Language pLanguage, PublishingStudio pStudio) {
    ...
    /**
     * Sets the base for what the prototype be.
     *
     * @param pPrototype
     */
    public void setPrototypeEpisode(Episode pPrototype) {
        aPrototype = pPrototype;
    }

    /**
     * Creates a new episode which is a direct clone of the Prototype episode indicated in the method above.
     * @return
     */
    public void createEpisode() {
        aEpisodes.add(aPrototype.clone());
    }
}
